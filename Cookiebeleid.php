...
<div align="justify" class="col-8 m-5 mb-5">
    ...
    Wat zijn cookies?
    Cookies zijn kleine, eenvoudige tekstbestandjes die jouw computer of mobiele apparaat opslaat wanneer je onze webwinkel gebruikt. Er zijn daarnaast ook cookie-achtige technieken waarmee dezelfde resultaten worden behaald, ook voor onze communicatie.
    ...
    Functionele of noodzakelijke cookies zorgen ervoor dat de webwinkel van bol.com goed functioneert. Denk hierbij aan:
    ...
    Meta
    Google
    Google reCAPTCHA (zie Privacy Policy en Terms of Use van Google)
    LinkedIn
    MOAT
    Salesforce DMP
    Selligent
    ...
    Om de effectiviteit van onze campagnes te meten, gebruiken we AppsFlyer. Lees meer over deze dienst: https://www.appsflyer.com/privacy-policy/;
    ...
    Daarnaast verzendt bol.com (bepaalde) push notificaties met behulp van de Google oplossing Firebase. Ook gebruiken wij Firebase om de betrouwbaarheid van de bol.com app te meten (prestaties en fouten) Lees meer over deze dienst: https://firebase.google.com/terms/;
    ...
    Met het gebruik van sommige cookies worden ook persoonsgegevens verwerkt zoals je hierboven hebt kunnen lezen. In ons privacybeleid vind je meer informatie over hoe bol.com met jouw gegevens omgaat.
    Slotopmerkingen
    Wij passen ons cookiebeleid aan wanneer onze webwinkel of de regels rondom cookies wijzigen. Je kunt de actuele versie van dit cookiebeleid raadplegen door onderaan elke pagina te klikken op de link naar het cookiebeleid van bol.com. Bekijk het volledige cookieoverzicht van bol.com (pdf)
